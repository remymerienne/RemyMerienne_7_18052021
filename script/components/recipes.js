...
[
  ...
  },
  {
    ...
    'time': 10,
    'description': 'Commencer par couper les feuilles de salade, ajouter les tomates cerises et le fromage découpé en cubes ou en boules avec la cuillère à melon. Découper le jambon de Parme en fines lamelles. Ajouter la pomme elle aussi découpée en petits morceaux. Assaisonnez à votre goût.',
    'appliance': 'Saladier',
  ...
  },
  {
    ...
    'time': 45,
    'description': 'Faire cuire les pâtes si vous n\'avez pas de pennes, des coquillettes peuvent faire l\'affaire. Découper les tomates en petits morceaux, soit en tranches soit en dés. Coupez le basilic en petites morceaux et mélangez le aux tomates.  Coupez la mozzarella en tranche. Préchauffez le four à 200°. Alternez entre couches de pattes et couches de tomates, terminez par une couche de pâte et recouvrir du fromage. Laisser au four 30 minutes et régalez vous ! Une recette simple qui fera plaisir au petits comme aux grands.',
    'appliance': 'Four',
  ...
  },
  {
    ...
    'time': 15,
    'description': 'Coupez les fraises en morceaux, découpez la chaire de la pastèque en retirant les pépins. Mettre le tout dans le blender. Ajouter une cuillière à soupe de juste de citron ainsi que les glaçons. Ajoutez quelques fueilles de menthe pour plus de fraicheur. Mixez le tout. Servir et déguster.',
    'appliance': 'Blender',
  ...
  },
  {
    ...
    'time': 60,
    'description': 'Etaler la pâte dans un moule et la piquer. Parsemer de beurre. Faire chauffer les lardon dans une poêle. Battre les oeufs en ajoutant la crème fraîche et le lait. Finalement ajouter les lardons, salez poivrez à votre goût. Verser l\'ensemble sur la pâte. Cuire environ 50 minutes.',
    'appliance': 'Four',
  ...
  },
  {
    ...
    'time': 35,
    'description': 'Râper les courgette et les faire revenir durant 15 minutes. Ajouter les fromages de chèvre frais. Préparer la béchamelle avec le lait et la maizena. Salez poivrez, ajouter de la noix de muscade selon les goûts. Dans un plat, mettre un peu de sauces au fond, puis des lasagnes, puis des courgettes etc... terminer par de la sauces et ajouter le gruiyère. Passer au four à 180° durant 20 à 25 minutes.',
    'appliance': 'Four',
  ...
  },
  {
    ...
    'time': 60,
    'description': 'Préparer la frangipane : Mélanger le sucre la poudre d\'amande, le beurre et les oeufs. Etaler la moitier de la pâte feuilletée et mettre dans un moule à tarte. Garnir de frangipane et recouvrir du reste de pête feuilletée. Mettre au four 30 minutes',
    'appliance': 'Four',
